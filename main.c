...
int main() {
    ...
    elmAvion1=ajouteAvion(elmAvion1,elmAvion2);
    elmAvion1=ajouteAvion(elmAvion1,elmAvion3);
    elmAvion1=ajouteAvion(elmAvion1,elmAvion4);
    elmAvion1=ajouteAvion(elmAvion1,elmAvion5);
